...
export function fakeBackendFactory(
  ...
  // no admin
  // tslint:disable-next-line:max-line-length
  // const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6Im1vc2hAZG9tYWluLmNvbSIsImFkbWluIjpmYWxzZX0.WEo1XhgSymH4fgQ6Yq4o6S-Jlx0j7WPprAPvuBWj31Y';
